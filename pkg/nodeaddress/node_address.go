...
func InitDefaultPrefix(device string) {
	...
	if ipv4AllocRange == nil {
		...
		log.WithField(logfields.V4Prefix, ipv4AllocRange).Info("Automatically added IPv4 allocation")
	}
	...
	if ipv6AllocRange == nil {
		...
		log.WithField(logfields.V6Prefix, ipv6AllocRange).Info("Automatically added IPv6 allocation")
	}
}
